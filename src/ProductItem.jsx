const ProductItem = ({ item }) => <div class="max-w-sm flex flex-col bg-white rounded-lg shadow mb-8">
    <a href="#" className="justify-start items-start">
        <img height={100} class="rounded-t-lg w-full h-80" src={item.image} alt={item.title} />
    </a>
    <div class="p-5">
        <a href="#">
